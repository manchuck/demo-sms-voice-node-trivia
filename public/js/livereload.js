...
(function() {
  let EventEmitter; let Server; let chokidar; let defaultExclusions; let defaultExts; let defaultPort; let fs; let http; let https; let path; let protocol_version; let url; let ws;
  ...
  Server = (function(superClass) {
    ...
    function Server(config1) {
      let base; let base1; let base2; let base3; let base4; let base5; let base6; let base7; let base8; let base9;
      this.config = config1;
      if (this.config == null) {
        this.config = {};
      }
    ...
    Server.prototype.filterRefresh = function(filepath) {
      let delayedRefresh; let fileext; let filename; let refresh;
      refresh = false;
  ...
  exports.createServer = function(config, callback) {
    let app; let requestHandler; let server;
    if (config == null) {
      config = {};
    }
